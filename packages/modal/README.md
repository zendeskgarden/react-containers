...
| -------------- | ----------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `modalRef`     | `RefObject`       | —          | Ref attached to the dialog element (required)                                                                                                                                                                                                                                                                           |
| `onClose`      | `(event) => void` | —          | Called when the modal should close                                                                                                                                                                                                                                                                                      |
| `idPrefix`     | `string`          | auto       | Prefix for generated `aria-labelledby` / `aria-describedby` IDs                                                                                                                                                                                                                                                         |
| `focusOnMount` | `boolean`         | `true`     | Move focus to the dialog element when it mounts                                                                                                                                                                                                                                                                         |
| `restoreFocus` | `boolean`         | `true`     | Return focus to the triggering element when the dialog unmounts                                                                                                                                                                                                                                                         |
| `environment`  | `Document`        | `document` | Document to use in iframe or custom environments                                                                                                                                                                                                                                                                        |
| `closeOnBlur`  | `boolean`         | `false`    | Close the modal when focus moves outside the dialog element. The WAI-ARIA Dialog pattern does not include blur as a dismissal mechanism; enable only for non-modal popovers (e.g. `TooltipDialog`) where light-dismiss on focus loss is intentional. Escape, close-button, and backdrop-click dismissal are unaffected. |
